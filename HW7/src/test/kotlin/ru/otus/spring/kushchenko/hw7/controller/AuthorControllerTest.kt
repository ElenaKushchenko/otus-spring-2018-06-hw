...
//        )
//
//        whenever(service.getAllShortBooks()).thenReturn(authors)
//
...
//        val authorRequest = author.toRequest()
//
//        whenever(service.create(Author(authorRequest))).thenReturn(author)
//
//        mockMvc.perform(
//            post(BASE_URL)
//                .contentType(MediaType.APPLICATION_JSON)
//                .content(authorRequest.asJsonString())
//        ).andDo(::print)
//            .andExpect(status().isOk)
//            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
//            .andExpect(content().json(author.asJsonString()))
//            .andReturn().response
//
//        verify(service).create(Author(authorRequest))
//        verifyNoMoreInteractions(service)
//    }
//
//    @Test
...
//        val authorRequest = author.toRequest()
//
//        whenever(service.update(Author(authorRequest, authorId))).thenReturn(author)
//
//        mockMvc.perform(
...
//            .andReturn().response
//
//        verify(service).update(Author(authorRequest, authorId))
//        verifyNoMoreInteractions(service)
//    }
//
//    @Test
...
//    }
//
//    private fun Author.toRequest() =
//        AuthorRequest(name = this.name!!)
//}