...
class CommentServiceImplTest {
    ...
    fun get() {
        ...
        val commentId = 1
        val comment = Comment(commentId, "Comment1", LocalDateTime.now(), user)
    ...
    fun create() {
        ...
        val comment = Comment(1, "Comment1", LocalDateTime.now(), user)
    ...
    fun updatingShouldThrowExceptionBecauseCommentIdIsNull() {
        ...
        val comment = Comment(text = "Comment1", user = user)
    ...
    fun updatingShouldThrowExceptionBecauseCommentIsNotExists() {
        ...
        val commentId = 100500
        val comment = Comment(id = commentId, text = "Comment100500", user = user)
