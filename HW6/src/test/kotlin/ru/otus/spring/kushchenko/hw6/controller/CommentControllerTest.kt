...
import ru.otus.spring.kushchenko.hw6.dto.CommentRequest
import ru.otus.spring.kushchenko.hw6.entity.Comment
import ru.otus.spring.kushchenko.hw6.entity.User
import ru.otus.spring.kushchenko.hw6.service.CommentService
...
class CommentControllerTest {
    ...
    fun update() {
        ...
        whenever(service.update(commentId, Comment(commentRequest))).thenReturn(comment)
        ...
        verify(service).update(commentId, Comment(commentRequest))
        verifyNoMoreInteractions(service)
    }
