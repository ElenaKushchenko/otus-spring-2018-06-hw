...
import ru.otus.spring.kushchenko.hw8.dto.BookRequest
...
class BookControllerTest {
    ...
    fun update() {
        ...
        whenever(service.update(Book(bookRequest, bookId))).thenReturn(book)
        ...
        verify(service).update(Book(bookRequest, bookId))
        verifyNoMoreInteractions(service)
    }
